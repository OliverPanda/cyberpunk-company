...
- installed adapter list for this Cyberpunk Company instance
...
## 8. New Skill: `cyberpunk-company-create-agent`

Create new skill directory:

- `skills/cyberpunk-company-create-agent/SKILL.md`
...
Also update `skills/cyberpunk-company/SKILL.md` to reference this skill for hiring workflows.
...
- `cyberpunk-company-create-agent` skill + docs updates
