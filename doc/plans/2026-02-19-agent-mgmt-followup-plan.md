...
- `skills/cyberpunk-company/SKILL.md` and `skills/cyberpunk-company/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/cyberpunk-company/SKILL.md`
...
## 6.2 `skills/cyberpunk-company-create-agent/SKILL.md`
