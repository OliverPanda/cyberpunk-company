...
Cyberpunk Company already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Cyberpunk Company should implement next.

## Product Goals

Cyberpunk Company should let operators:
...
For the next implementation pass, Cyberpunk Company should enforce these defaults:
...
Cyberpunk Company should separate subscription-included usage from billed spend:
...
Cyberpunk Company should have two threshold classes:
...
Cyberpunk Company must know that a project is budget-paused and enforce it.
...
Cyberpunk Company must also block execution before new work starts.
