...
This document defines the rollout plan for adapter-wide skill support in Cyberpunk Company.
...
- Cyberpunk Company stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

Cyberpunk Company currently has these adapters:
...
1. Desired skills live in Cyberpunk Company for every adapter.
...
These adapters have a stable local skills directory that Cyberpunk Company can read and manage.
...
These adapters do not have a meaningful Cyberpunk Company-owned persistent install state.
...
- show desired Cyberpunk Company skills
...
- desired skills stored in Cyberpunk Company
...
- runtime already injects Cyberpunk Company skills into `~/.cursor/skills`
...
4. Distinguish:
   - managed Cyberpunk Company skills
...
- runtime already injects Cyberpunk Company skills into `~/.gemini/skills`
...
- runtime already injects Cyberpunk Company skills into `~/.pi/agent/skills`
...
- Cyberpunk Company can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects Cyberpunk Company skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- Cyberpunk Company may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed Cyberpunk Company skills that are clearly marked as Cyberpunk Company-managed
...
- Cyberpunk Company stores desired skills only
...
- avoid destructive wording unless Cyberpunk Company can prove a skill is Cyberpunk Company-managed
...
That gets Cyberpunk Company from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
