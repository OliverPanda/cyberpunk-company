...
This is intentionally separate from the normal Cyberpunk Company dev image.
...
```sh
review-checkout-pr cyberpunk-company/cyberpunk-company 432
cd /work/checkouts/cyberpunk-company-cyberpunk-company/pr-432
```
...
## Preview the Cyberpunk Company app from the PR
...
- Cyberpunk Company's embedded PostgreSQL and local storage stay inside the container home volume via `CYBERPUNK_HOME=/home/reviewer/.cyberpunk-company-review`.
