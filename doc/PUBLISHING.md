...
Low-level reference for how Cyberpunk Company packages are prepared and published to npm.
...
Cyberpunk Company no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `cyberpunk-company`, imports code from workspace packages such as:

- `@cyberpunk-company/server`
- `@cyberpunk-company/db`
- `@cyberpunk-company/shared`
...
## `@cyberpunk-company/ui` packaging
...
Cyberpunk Company uses calendar versions:
...
- `cyberpunk-company@2026.318.1-canary.2`
