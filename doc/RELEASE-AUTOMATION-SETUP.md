...
This document covers the GitHub and npm setup required for the current Cyberpunk Company release model:
...
Do this for every public package that Cyberpunk Company publishes.

At minimum that includes:

- `cyberpunk-company`
- `@cyberpunk-company/server`
- `@cyberpunk-company/ui`
...
3. add a trusted publisher for the GitHub repository `cyberpunk-company/cyberpunk-company`
...
- `cyberpunk-company/cyberpunk-company`
...
2. revoke any personal automation token that used to publish Cyberpunk Company
