...
- Running a Python script that calls the Cyberpunk Company API
...
1. Cyberpunk Company spawns the configured command as a child process
2. Standard Cyberpunk Company environment variables are injected (`CYBERPUNK_AGENT_ID`, `CYBERPUNK_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Cyberpunk Company API and perform work.
