...
summary: What adapters are and how they connect agents to Cyberpunk Company
---

Adapters are the bridge between Cyberpunk Company's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Cyberpunk Company:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `cyberpunk-company run --watch`
```
