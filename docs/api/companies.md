...
Manage companies within your Cyberpunk Company instance.
...
Company logo uploads use the normal Cyberpunk Company attachment size limit.
...
| `logoUrl` | string | Optional Cyberpunk Company asset content path for the stored logo image |
