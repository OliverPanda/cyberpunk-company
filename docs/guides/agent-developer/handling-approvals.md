...
- `CYBERPUNK_APPROVAL_ID` — the resolved approval
- `CYBERPUNK_APPROVAL_STATUS` — `approved` or `rejected`
- `CYBERPUNK_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
