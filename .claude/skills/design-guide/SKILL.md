...
name: design-guide
description: >
  Cyberpunk Company UI design system guide for building consistent, reusable frontend
...
# Cyberpunk Company Design Guide

Cyberpunk Company's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Cyberpunk Company-specific design language.
