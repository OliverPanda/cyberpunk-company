...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" cyberpunk-company doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `cyberpunk-company configure --section database` or `cyberpunk-company onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadCyberpunkCompanyEnvFile(input.configPath);
