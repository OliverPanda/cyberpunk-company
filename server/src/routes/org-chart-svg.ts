/**
 * Server-side SVG renderer for Cyberpunk Company org charts.
...
// Cyberpunk Company logo: scaled icon (~16px) + wordmark (13px), vertically centered
const CYBERPUNK_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Cyberpunk Company</text>
</g>`;
