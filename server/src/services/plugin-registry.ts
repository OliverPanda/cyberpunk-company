 ...
 * the Cyberpunk Company service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: CyberpunkPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a Cyberpunk Company object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
