 ...
 */
import type { CompanyPortabilityManifest } from "@cyberpunk-company/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Cyberpunk Company](https://cyberpunk-company.ing)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Cyberpunk Company](https://cyberpunk-company.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Cyberpunk Company](https://cyberpunk-company.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
