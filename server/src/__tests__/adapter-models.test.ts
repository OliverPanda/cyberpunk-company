...
import { models as codexFallbackModels } from "@cyberpunk-company/adapter-codex-local";
import { models as cursorFallbackModels } from "@cyberpunk-company/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@cyberpunk-company/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.CYBERPUNK_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.CYBERPUNK_OPENCODE_COMMAND = "__cyberpunk-company_missing_opencode_command__";
