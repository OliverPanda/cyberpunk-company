...
const ORIGINAL_CYBERPUNK_LISTEN_PORT = process.env.CYBERPUNK_LISTEN_PORT;
const ORIGINAL_HOST = process.env.HOST;
const ORIGINAL_PORT = process.env.PORT;

afterEach(() => {
  if (ORIGINAL_CYBERPUNK_API_URL === undefined) delete process.env.CYBERPUNK_API_URL;
  else process.env.CYBERPUNK_API_URL = ORIGINAL_CYBERPUNK_API_URL;

  if (ORIGINAL_CYBERPUNK_LISTEN_HOST === undefined) delete process.env.CYBERPUNK_LISTEN_HOST;
  else process.env.CYBERPUNK_LISTEN_HOST = ORIGINAL_CYBERPUNK_LISTEN_HOST;

  if (ORIGINAL_CYBERPUNK_LISTEN_PORT === undefined) delete process.env.CYBERPUNK_LISTEN_PORT;
  else process.env.CYBERPUNK_LISTEN_PORT = ORIGINAL_CYBERPUNK_LISTEN_PORT;
...
describe("buildPaperclipEnv", () => {
  ...
  it("uses runtime listen host/port when explicit URL is not set", () => {
    delete process.env.CYBERPUNK_API_URL;
    process.env.CYBERPUNK_LISTEN_HOST = "0.0.0.0";
    process.env.CYBERPUNK_LISTEN_PORT = "3101";
