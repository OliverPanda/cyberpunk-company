...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Cyberpunk Company state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".cyberpunk-company/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/cyberpunk-company",
      ),
    ).toBe(false);
