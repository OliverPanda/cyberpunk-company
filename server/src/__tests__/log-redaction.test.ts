...
describe("log redaction", () => {
  it("redacts the active username inside home-directory paths", () => {
    const userName = "cyberpunk-companyuser";
  ...
  it("redacts standalone username mentions without mangling larger tokens", () => {
    ...
    const result = redactCurrentUserText(
      `user ${userName} said ${userName}/project should stay but acyberpunk-companyuserz should not change`,
      {
        userNames: [userName],
        homeDirs: [],
      },
    ...
    expect(result).toBe(
      `user ${maskedUserName} said ${maskedUserName}/project should stay but acyberpunk-companyuserz should not change`,
    );
  });
  ...
  it("skips redaction when disabled", () => {
    const input = "cwd=/Users/cyberpunk-companyuser/cyberpunk-company";
