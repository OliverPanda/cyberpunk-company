...
`,
  ...
  writeFile(
    ...
    `import type { PaperclipPluginManifestV1 } from "@cyberpunk-company/plugin-sdk";
...
${sdkDependency.startsWith("file:")
  ? `This scaffold snapshots \`@cyberpunk-company/plugin-sdk\` and \`@cyberpunk-company/shared\` from a local Paperclip checkout at:\n\n\`${toPosixPath(localSdkPath)}\`\n\nThe packed tarballs live in \`.paperclip-sdk/\` for local development. Before publishing this plugin, switch those dependencies to published package versions once they are available on npm.\n\n`
  : ""}
