...
const manifest: CyberpunkPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Cyberpunk Company plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Cyberpunk Company domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
