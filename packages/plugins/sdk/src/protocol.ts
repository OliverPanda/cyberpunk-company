 ...
 * channel.
 *
 * The Cyberpunk Company plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all Cyberpunk Company messages.
 */
...
/**
 * Cyberpunk Company plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Cyberpunk Company instance. */
    instanceId: string;
    /** Semver version of the running Cyberpunk Company host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
