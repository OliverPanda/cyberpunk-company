/**
 * Core types for the Cyberpunk Company plugin worker-side SDK.
 *
 * These types define the stable public API surface that plugin workers import
 * from `@cyberpunk-company/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @cyberpunk-company/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
...
export interface ScopeKey {
  /** What kind of Cyberpunk Company object this state is scoped to. */
...
export interface PluginEntityUpsert {
  ...
  externalId?: string;
  /** Human-readable title for display in the Cyberpunk Company UI. */
  title?: string;
...
/**
 * `ctx.events` — subscribe to and emit Cyberpunk Company domain events.
 *
...
export interface PluginEventsClient {
  /**
   * Subscribe to a core Cyberpunk Company domain event or a plugin-namespaced event.
   *
 ...
 * This client resolves the reference through the Cyberpunk Company secret provider
...
export interface PluginSecretsClient {
   ...
   * in the Cyberpunk Company secret provider (e.g. `"MY_API_KEY"`).
   *
 ...
 * ```
 *
 * @see usePluginStream in `@cyberpunk-company/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@cyberpunk-company/plugin-sdk";
 *
