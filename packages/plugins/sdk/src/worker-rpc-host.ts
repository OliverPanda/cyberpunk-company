...
import type { CyberpunkPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@cyberpunk-company/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: CyberpunkPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@cyberpunk-company/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
