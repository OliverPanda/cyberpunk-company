/**
 * Bundling presets for Cyberpunk Company plugins.
 *
 ...
 * to match the Cyberpunk Company plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@cyberpunk-company/plugin-sdk/ui",
    "@cyberpunk-company/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@cyberpunk-company/plugin-sdk"],
  };
