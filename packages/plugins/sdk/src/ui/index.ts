/**
 * `@cyberpunk-company/plugin-sdk/ui` — Cyberpunk Company plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@cyberpunk-company/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@cyberpunk-company/plugin-sdk/ui";
 *
