 ...
 *
 * These components are exported from `@cyberpunk-company/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@cyberpunk-company/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function CyberpunkCompanySdkUiComponent(props: TProps) {
