...
function requireCapability(manifest: CyberpunkPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Cyberpunk Company server runtime.
 */
