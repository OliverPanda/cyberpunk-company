/**
 * `definePlugin` — the top-level helper for authoring a Cyberpunk Company plugin.
 *
...
// ---------------------------------------------------------------------------
// CyberpunkPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface CyberpunkPlugin {
...
/**
 * Define a Cyberpunk Company plugin.
 *
 ...
 * @returns A sealed `CyberpunkPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@cyberpunk-company/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): CyberpunkPlugin {
