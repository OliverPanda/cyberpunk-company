...
import type { ProviderQuotaResult, QuotaWindow } from "@cyberpunk-company/adapter-utils";
    ...
    return {
      ...
      error:
        errors.length > 0
          ...
          : `${authDescription}, but Cyberpunk Company could not load subscription quota data`,
      windows: [],
    };
  }
