...
function renderApiAccessNote(env: Record<string, string>): string {
  ...
  return [
    ...
    "POST/PATCH example:",
    `  run_shell_command({ command: "curl -s -X POST -H \\"Authorization: Bearer $CYBERPUNK_API_KEY\\" -H 'Content-Type: application/json' -H \\"X-Paperclip-Run-Id: $CYBERPUNK_RUN_ID\\" -d '{...}' \\"$CYBERPUNK_API_URL/api/issues/{id}/checkout\\"" })`,
    "",
    "",
  ].join("\n");
}
