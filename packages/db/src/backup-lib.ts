...
const STATEMENT_BREAKPOINT = "-- cyberpunk-company statement breakpoint 69f6f3f1-42fd-46a6-bf17-d1d85f8f3900";
...
export async function runDatabaseBackup(opts: RunDatabaseBackupOptions): Promise<RunDatabaseBackupResult> {
  const filenamePrefix = opts.filenamePrefix ?? "cyberpunk-company";
  ...
  try {
    ...
    emit("-- Cyberpunk Company database backup");
