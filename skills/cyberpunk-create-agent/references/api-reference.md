# Cyberpunk Company Create Agent API Reference
...
- After approval resolution, requester may be woken with `CYBERPUNK_APPROVAL_ID` and should reconcile linked issues.
