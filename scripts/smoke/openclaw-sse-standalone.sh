...
CYBERPUNK_COMPANY_ID="${CYBERPUNK_COMPANY_ID:-openclaw-smoke-company}"
CYBERPUNK_API_URL="${CYBERPUNK_API_URL:-http://localhost:3100}"
CYBERPUNK_TASK_ID="${CYBERPUNK_TASK_ID:-openclaw-smoke-task}"
CYBERPUNK_WAKE_REASON="${CYBERPUNK_WAKE_REASON:-openclaw_smoke_test}"
CYBERPUNK_WAKE_COMMENT_ID="${CYBERPUNK_WAKE_COMMENT_ID:-}"
CYBERPUNK_APPROVAL_ID="${CYBERPUNK_APPROVAL_ID:-}"
...
CYBERPUNK_RUN_ID=${CYBERPUNK_RUN_ID}
CYBERPUNK_AGENT_ID=${CYBERPUNK_AGENT_ID}
CYBERPUNK_COMPANY_ID=${CYBERPUNK_COMPANY_ID}
CYBERPUNK_API_URL=${CYBERPUNK_API_URL}
CYBERPUNK_TASK_ID=${CYBERPUNK_TASK_ID}
CYBERPUNK_WAKE_REASON=${CYBERPUNK_WAKE_REASON}
CYBERPUNK_WAKE_COMMENT_ID=${CYBERPUNK_WAKE_COMMENT_ID}
CYBERPUNK_APPROVAL_ID=${CYBERPUNK_APPROVAL_ID}
CYBERPUNK_APPROVAL_STATUS=${CYBERPUNK_APPROVAL_STATUS}
CYBERPUNK_LINKED_ISSUE_IDS=${CYBERPUNK_LINKED_ISSUE_IDS}
...
PAYLOAD="$(jq -nc \
  ...
  --arg runId "$CYBERPUNK_RUN_ID" \
  --arg agentId "$CYBERPUNK_AGENT_ID" \
  --arg companyId "$CYBERPUNK_COMPANY_ID" \
  --arg apiUrl "$CYBERPUNK_API_URL" \
  --arg taskId "$CYBERPUNK_TASK_ID" \
  --arg wakeReason "$CYBERPUNK_WAKE_REASON" \
  --arg wakeCommentId "$CYBERPUNK_WAKE_COMMENT_ID" \
  --arg approvalId "$CYBERPUNK_APPROVAL_ID" \
  --arg approvalStatus "$CYBERPUNK_APPROVAL_STATUS" \
  --arg linkedIssueIds "$CYBERPUNK_LINKED_ISSUE_IDS" \
  '{
    model: $model,
    user: $user,
    input: $text,
    stream: true,
    metadata: {
      CYBERPUNK_RUN_ID: $runId,
      CYBERPUNK_AGENT_ID: $agentId,
      CYBERPUNK_COMPANY_ID: $companyId,
      CYBERPUNK_API_URL: $apiUrl,
      CYBERPUNK_TASK_ID: $taskId,
      CYBERPUNK_WAKE_REASON: $wakeReason,
      CYBERPUNK_WAKE_COMMENT_ID: $wakeCommentId,
