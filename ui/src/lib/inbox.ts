...
export const DISMISSED_KEY = "cyberpunk:inbox:dismissed";
export const READ_ITEMS_KEY = "cyberpunk:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "cyberpunk:inbox:last-tab";
