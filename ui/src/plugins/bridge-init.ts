 ...
 *
 * This is placed on `globalThis.__cyberpunkPluginBridge__` and consumed by
...
declare global {
  ...
  var __cyberpunkPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__cyberpunkPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__cyberpunkPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
