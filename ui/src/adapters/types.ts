...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@cyberpunk-company/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@cyberpunk-company/adapter-utils").TranscriptEntry[];
