...
export function BoardClaimPage() {
  ...
  if (!token || !code) {
    return <div className="mx-auto max-w-xl py-10 text-sm text-destructive">董事会认领链接无效。</div>;
  }
  ...
  if (status.status === "claimed") {
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          <h1 className="text-lg font-semibold">已认领董事会所有权</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            此实例现已绑定到你的登录用户。
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          这会将你的用户提升为实例管理员，并把公司的所有权访问从本地可信模式迁移过来。
        </p>
