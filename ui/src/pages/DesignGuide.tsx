...
export function DesignGuide() {
  ...
  const [inlineText, setInlineText] = useState("点击即可编辑这段文字");
  const [inlineTitle, setInlineTitle] = useState("可编辑标题");
  const [inlineDesc, setInlineDesc] = useState(
    "这是一段可编辑描述。点击即可编辑，文本框会自动调整高度以适应内容，同时避免布局跳动。"
  );
    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          汇总 Cyberpunk Company 中使用的全部组件、样式与交互模式。
        </p>
      </div>
      ...
      <Section title="颜色">
        <SubSection title="核心">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <Swatch name="次色" cssVar="--secondary" />
            <Swatch name="弱化色" cssVar="--muted" />
      ...
      <Section title="排版">
        <div className="space-y-3">
          ...
          <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">
            分区小标题 — text-sm font-semibold uppercase tracking-wide
          </h3>
          <p className="text-sm font-medium">卡片标题 — text-sm font-medium</p>
          <p className="text-sm font-semibold">卡片标题替代样式 — text-sm font-semibold</p>
          <p className="text-sm">正文文本 — text-sm</p>
          <p className="text-sm text-muted-foreground">
            弱化描述 — text-sm text-muted-foreground
          </p>
          ...
          <p className="text-2xl font-bold">大号统计数字 — text-2xl font-bold</p>
      ...
      <Section title="状态系统">
        ...
        <SubSection title="PriorityIcon（可交互）">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm">点击图标切换优先级（当前：{priority}）</span>
          </div>
        </SubSection>
      ...
      <Section title="表单元素">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <SubSection title="多行文本">
            <Textarea placeholder="写点内容..." />
          </SubSection>
          ...
          <SubSection title="行内编辑器">
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs text-muted-foreground mb-1">描述（多行，自适应高度）</p>
                <InlineEditor
                  value={inlineDesc}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <SubSection title="默认尺寸">
            <Select value={selectValue} onValueChange={setSelectValue}>
              ...
              <SelectContent>
                <SelectItem value="backlog">待整理</SelectItem>
      ...
      <Section title="悬浮弹层">
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm">打开弹层</Button>
          </PopoverTrigger>
          <PopoverContent className="space-y-2">
            <p className="text-sm font-medium">智能体心跳</p>
            <p className="text-xs text-muted-foreground">
              上次运行于 24 秒前成功完成。下一次定时运行将在 9 分钟后触发。
            </p>
      ...
      <Section title="面包屑">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Cyberpunk Company App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>议题列表</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </Section>
      ...
      <Section title="卡片">
        <SubSection title="标准卡片">
          <Card>
            <CardHeader>
              ...
              <CardDescription>卡片描述与辅助说明文字。</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm">卡片内容放在这里，这是主要正文区域。</p>
            </CardContent>
        ...
        <SubSection title="指标卡片">
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <MetricCard icon={CircleDot} value={48} label="未结议题" />
            <MetricCard icon={DollarSign} value="$1,234" label="月度成本" description="未超预算" />
            <MetricCard icon={Zap} value="99.9%" label="在线率" />
          </div>
        </SubSection>
      </Section>
      ...
      <Section title="身份标识">
        <SubSection title="尺寸">
          <div className="flex items-center gap-6">
            <Identity name="智能体阿尔法" size="sm" />
            <Identity name="智能体阿尔法" />
            <Identity name="智能体阿尔法" size="lg" />
          </div>
        </SubSection>

        <SubSection title="缩写推导">
          <div className="flex flex-col gap-2">
            <Identity name="CEO 智能体" size="sm" />
            <Identity name="阿尔法" size="sm" />
            <Identity name="质量保障负责人" size="sm" />
          </div>
        </SubSection>

        <SubSection title="自定义缩写">
        ...
        <div className="flex items-center gap-4">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="outline" size="sm">悬停试试</Button>
            </TooltipTrigger>
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                这是一个示例对话框，展示了带有头部、内容区和底部操作区的标准布局。
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
              <div>
              ...
              <div>
                <Label>描述</Label>
                <Textarea placeholder="填写描述..." className="mt-1.5" />
              </div>
            </div>
            <DialogFooter>
              <Button variant="outline">取消</Button>
      ...
      <Section title="空状态">
        <div className="border border-border rounded-md">
          <EmptyState
            icon={Inbox}
            message="当前没有可展示的内容。创建第一个条目即可开始。"
            action="创建条目"
            onAction={() => {}}
          />
        </div>
      ...
      <Section title="进度条（预算）">
        <div className="space-y-3">
          {[
            { label: "预算内（40%）", pct: 40, color: "bg-green-400" },
            { label: "警戒线（75%）", pct: 75, color: "bg-yellow-400" },
            { label: "超预算（95%）", pct: 95, color: "bg-red-400" },
          ].map(({ label, pct, color }) => (
      ...
      <Section title="日志查看器">
        <div className="bg-neutral-950 rounded-lg p-3 font-mono text-xs max-h-80 overflow-y-auto">
          ...
          <div className="text-red-400">[12:00:12] ERROR 上游服务连接超时</div>
        ...
        <div className="border border-border rounded-md p-4 space-y-1 max-w-sm">
          ...
          <div className="flex items-center justify-between py-1.5">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs">智能体阿尔法</span>
            </div>
          </div>
          <div className="flex items-center justify-between py-1.5">
            <span className="text-xs text-muted-foreground">创建时间</span>
            <span className="text-xs">2025 年 1 月 15 日</span>
          </div>
        </div>
      </Section>
          ...
          <div className="space-y-3">
            <div className="rounded-md border border-border p-3">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs text-muted-foreground">2025 年 1 月 15 日</span>
              </div>
              <p className="text-sm">已开始处理鉴权模块，需要先配置 API 密钥。</p>
            </div>
            <div className="rounded-md border border-border p-3">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-muted-foreground">人工成员</span>
                <span className="text-xs text-muted-foreground">2025 年 1 月 16 日</span>
              </div>
              <p className="text-sm">API 密钥已加入密钥库，请继续。</p>
            </div>
          </div>
          <div className="space-y-2">
      ...
      <Section title="分隔线">
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">横向</p>
          <Separator />
