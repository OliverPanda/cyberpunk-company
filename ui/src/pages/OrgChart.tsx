...
import { AGENT_ROLE_LABELS, type Agent } from "@cyberpunk-company/shared";
...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message="请选择公司以查看组织架构图。" />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message="尚未定义组织层级结构。" />;
  }
