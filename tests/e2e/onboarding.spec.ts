 ...
 * heartbeat fires. Set CYBERPUNK_E2E_SKIP_LLM=false to enable LLM-dependent
 * assertions (requires a valid ANTHROPIC_API_KEY).
 */

const SKIP_LLM = process.env.CYBERPUNK_E2E_SKIP_LLM !== "false";
...
test.describe("Onboarding wizard", () => {
  test("completes full wizard flow", async ({ page }) => {
    ...
    expect(task.description).not.toContain("github.com/cyberpunk-company/companies");
